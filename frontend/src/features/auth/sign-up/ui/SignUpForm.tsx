...
/**
 * Описывает пропсы формы регистрации.
 */
type Props = {
  /** Блок кнопок альтернативной авторизации. */
...
const signUpErrorKeyMap: Record<string, string> = {
  ...
  'password.invalid_format':
    'auth.signUp.fields.password.errors.invalid_format',
...
/**
 * Отображает форму регистрации пользователя с локальной валидацией.
 */
export function SignUpForm(props: Props) {
  ...
  return (
    ...
    >
      ...
      <Text className={classes.subtitle}>{t('auth.signUp.subtitle')}</Text>
      {socialAuth}
      <Divider
