...
/**
 * Отображает форму входа пользователя с локальной валидацией и social auth.
 */
export function SignInForm(props: IProps) {
  ...
  return (
    ...
    >
      ...
      <Text className={classes.subtitle}>{t('auth.signIn.subtitle')}</Text>
      {socialAuth}
      <Divider
